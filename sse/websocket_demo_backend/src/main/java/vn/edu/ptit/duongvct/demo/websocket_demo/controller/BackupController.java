...
//        }
        ...
        String clientIdentifier = user != null ? user.getUsername() : "unknown";
        producerService.sendMessage(topicBackupCommand, actionLog.getAction() + " " + actionLog.getEntityType() + " " + backup.getId() + " " + clientIdentifier);
        saved.setUser(null);
        return saved;
    }
